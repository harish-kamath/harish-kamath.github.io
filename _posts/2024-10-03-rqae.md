...
However, Large Language Models (LLMs) are a different beast. Text is a much denser medium than visuals when it comes to interpretable features, and these models are orders of magnitude larger than any other models we've ever made. This work is heavily inspired by transformer-circuits, which has laid out an incredible foundation for how we can begin to interpret LLMs. If you're new to interpretability, I would recommend reading these works first, but I'll also provide a quick rundown of the core concepts in this section.
