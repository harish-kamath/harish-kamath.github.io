...
If you mainly care about experimental results, start <a href="#algorithms">here</a>.
If you mainly care about the connection to SAEs, start <a href="#a-close-resemblance-to-saes">here</a>.</p>
</div>
...
<div class="caption">
    <b>Figure 3b.</b> Reconstruction loss of RQAE vs SAE with varying width and L0. Note that the same RQAE model is used here (num_quantizers=1024), and reconstruction is stopped early, rather than different RQAE models trained with different num_quantizers.
</div>
